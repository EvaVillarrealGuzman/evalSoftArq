...
public class HibernateManager extends HibernateUtil{
	...
	public boolean saveObject(Object pobjet) {
        try {
			...
			JOptionPane.showOptionDialog(
					   ...
					   new ImageIcon(FrmSystemManagement.class.getResource("/Icons/success.png")),    
					   new Object[] { "OK"}, "OK");
            return true;
        } catch (Exception pex) {
            System.out.println("error " + pex);
            System.out.println("Repository.saveObjet(Object objetj)" + pobjet.getClass() + ": " + pobjet.toString() + pex);
            pex.printStackTrace();
			JOptionPane.showOptionDialog(
					   null,
					   "The object can not be saved", 
					   "Error",
					   JOptionPane.YES_NO_CANCEL_OPTION,
					   JOptionPane.ERROR_MESSAGE,
					   new ImageIcon(FrmSystemManagement.class.getResource("/Icons/error.png")),    
					   new Object[] { "OK"}, "OK");
            getTx().rollback();
            return false;
        }
    ...
    public boolean updateObject(Object pobjet) {
        ...
        try {
			...
			JOptionPane.showOptionDialog(
					   null,
					   "The object can not be updated" + pe.getMessage(), 
					   "Error",
					   JOptionPane.YES_NO_CANCEL_OPTION,
					   JOptionPane.ERROR_MESSAGE,
					   new ImageIcon(FrmSystemManagement.class.getResource("/Icons/error.png")),    
