...
public class HibernateManager extends HibernateUtil {
	...
	public boolean saveObject(Object pobjet) {
		try {
			...
			JOptionPane.showOptionDialog(null, "Done successfully!", "Notice", JOptionPane.YES_NO_CANCEL_OPTION,
					...
					new ImageIcon(FrmSystemManagement.class.getResource("/Icons/success.png")), new Object[] { "OK" },
					"OK");
			return true;
		} catch (Exception pex) {
			...
			JOptionPane.showOptionDialog(null, "The object can not be saved", "Error", JOptionPane.YES_NO_CANCEL_OPTION,
					JOptionPane.ERROR_MESSAGE, new ImageIcon(FrmSystemManagement.class.getResource("/Icons/error.png")),
					new Object[] { "OK" }, "OK");
			getTx().rollback();
			return false;
		}
	...
	public boolean updateObject(Object pobjet) {
		...
		try {
			...
			JOptionPane.showOptionDialog(null, "Done successfully!", "Notice", JOptionPane.YES_NO_CANCEL_OPTION,
					JOptionPane.INFORMATION_MESSAGE,
					new ImageIcon(FrmSystemManagement.class.getResource("/Icons/error.png")), new Object[] { "OK" },
					"OK");
			return true;
