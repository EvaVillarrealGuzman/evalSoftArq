...
/**
 * This class defines the concrete response measure of a particular scenario of quality
 * @author: FEM
 * @version: 06/11/2015
 */
...
public class ResponseMeasure implements Comparable{
	...
	public ResponseMeasure(String pdescription, Double pvalue,ResponseMeasureType ptype,
			Metric pmetric, Unit punit) {
		super();
