...
public class DoubleFieldEditor2 extends StringFieldEditor {
	/**
	...
	private SearchQualityRequirementPreferencePage form;
	 ...
	 */
	public DoubleFieldEditor2(String name, String labelText, Composite parent, SearchQualityRequirementPreferencePage f) {
		this(name, labelText, parent, DoubleFieldEditor2.DEFAULT_TEXT_LIMIT);
		form = f;
	}
	
	public DoubleFieldEditor2(String name, String labelText, Composite parent) {
		this(name, labelText, parent, DoubleFieldEditor2.DEFAULT_TEXT_LIMIT);
	}
	 ...
	 */
	public DoubleFieldEditor2(String name, String labelText, Composite parent, int textLimit) {
		init(name, labelText);
		this.parent = parent;
	...
	public SearchQualityRequirementPreferencePage getForm() {
		return form;
	}

	public void setForm(SearchQualityRequirementPreferencePage form) {
		this.form = form;
	}
